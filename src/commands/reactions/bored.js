...
module.exports = {
  ...
  description: 'Express your boredom.',
  guildOnly: process.env.DEV_MODE === 'TRUE',
  ...
  callback: async ({ interaction }) => {
    ...
    try {
      const helperData = await funHelper.nekosBest('bored')

      const newEmbed = new EmbedBuilder()
        .setTitle(`${author} could use some excitement.`)
